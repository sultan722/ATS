...
def cum_ret(df_ret_port, df_data,df_port_avg,d f_port_avg_2):
    ...
    df_ewcum.append((1+df_data['US Cash'].tail(417-12)+(df_ret_port)*(df_port_avg_2.iloc[0,1]/df_port_avg.iloc[0,1]))
    
    1+df_data['US Cash'].tail(417-12)+(df_ret_port)*(df_port_avg_2.iloc[0,1]/df_port_avg.iloc[0,1])
